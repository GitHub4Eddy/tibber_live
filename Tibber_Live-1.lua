...
function QuickApp:updateLabels() -- Update the labels
  ...
  labelText = labelText .."Last hour Consumption: " ..string.format("%.1f",data.payload.data.liveMeasurement.accumulatedConsumptionLastHour) .." kWh" .."\n"
  labelText = labelText .."Last hour Production: " ..string.format("%.1f",data.payload.data.liveMeasurement.accumulatedProductionLastHour) .." kWh" .."\n\n"

  labelText = labelText .."Todays Consumption:" ..string.format("%.1f",data.payload.data.liveMeasurement.accumulatedConsumption) .." kWh" .."\n"
  labelText = labelText .."Minimum: " ..string.format("%.1f",data.payload.data.liveMeasurement.minPower) .." Watt" .."\n"
  labelText = labelText .."Maximum: " ..string.format("%.1f",data.payload.data.liveMeasurement.maxPower) .." Watt" .."\n"
  labelText = labelText .."Average: " ..string.format("%.1f",data.payload.data.liveMeasurement.averagePower) .." Watt" .."\n\n"
  
  labelText = labelText .."Todays Production: " ..string.format("%.1f",data.payload.data.liveMeasurement.accumulatedProduction) .." kWh" .."\n"
  labelText = labelText .."Minimum: " ..string.format("%.1f",data.payload.data.liveMeasurement.minPowerProduction) .." Watt" .."\n"
  labelText = labelText .."Maximum: " ..string.format("%.1f",data.payload.data.liveMeasurement.maxPowerProduction) .." Watt" .."\n\n"
  ...
  labelText = labelText .."L1: " ..string.format("%.0f",data.payload.data.liveMeasurement.voltagePhase1) .." - L2: " ..string.format("%.0f",data.payload.data.liveMeasurement.voltagePhase2) .." - L3: " ..string.format("%.0f",data.payload.data.liveMeasurement.voltagePhase3) .." Amp " .."\n\n"
  
  labelText = labelText .."Ampere:" .."\n"
  labelText = labelText .."L1: " ..string.format("%.2f",data.payload.data.liveMeasurement.currentL1) .." - L2: " ..string.format("%.2f",data.payload.data.liveMeasurement.currentL2) .." - L3: " ..string.format("%.2f",data.payload.data.liveMeasurement.currentL3) .." Volt " .."\n\n"
...
function QuickApp:getValues() -- Get the values from json file 
  ...
  if data.payload.data.liveMeasurement.voltagePhase1 == "null" or data.payload.data.liveMeasurement.voltagePhase1 == nil then 
  ...
  if data.payload.data.liveMeasurement.voltagePhase2 == "null" or data.payload.data.liveMeasurement.voltagePhase2 == nil then
  ...
  if data.payload.data.liveMeasurement.voltagePhase3 == "null" or data.payload.data.liveMeasurement.voltagePhase3 == nil then
...
function QuickApp:getQuickAppVariables() -- Check existence of the mandatory variables, if not, create them with default values
  ...
  if timeout == "" or timeout == nil or timeout == 0 then
    timeout = "300" -- Default timeout after maximum re-connects
...
function QuickApp:setupChildDevices() -- Setup Child Devices
  ...
  if #cdevs == 0 then -- If no Child Devices, create them
    local initChildData = { 
      ...
      {className="lastMeterConsumption", name="Total Consumption", type="com.fibaro.electricMeter", value=0},
      {className="lastMeterProduction", name="Total Production", type="com.fibaro.electricMeter", value=0},
